...
sed -i -e $'s/dependencies {/dependencies {\\\n        classpath "com.google.gms:google-services:4.3.12"/' android/build.gradle
...
echo "project.ext{set('react-native',[versions:[firebase:[bom:'30.2.0'],],])}" >> android/build.gradle
